...
--b) Without running this, analyze the data. What product will be in both the warehouse and the store inventory? In other
-- words, what product or products is in BOTH tables? Answer: Painting
